...
class App extends React.Component {
    ...
    render() {
        const { simpleListState, groupLeftState, groupRightState } = this.state;
        const simpleList = simpleListState.map((val, key) => (
            <li key={uniqueId()} data-id={val}>
                List Item {val}
            </li>
        ));
        const groupLeft = groupLeftState.map((val, key) => (
            <div key={uniqueId()} data-id={val}>
                {val}
            </div>
        ));
        const groupRight = groupRightState.map((val, key) => (
            <div key={uniqueId()} data-id={val}>
                {val}
            </div>
        ));
